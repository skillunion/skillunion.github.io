...
if (!Ext.ClassManager.classes['WSEcho.en.Languages']) {
  Ext.define('WSEcho.en.Languages', {messages:{closeConfirm:'Close a connection?'}});
}
Ext.define('WSEcho.en.view.Main', {override:'WSEcho.view.Main', titleDefault:'WebSocket Echo Test'});
if (!Ext.ClassManager.classes['WSEcho.ru.Languages']) {
  Ext.define('WSEcho.ru.Languages', {messages:{closeConfirm:'Закрыть соединение?'}});
}
Ext.define('WSEcho.ru.view.Main', {override:'WSEcho.view.Main', titleDefault:'Тест WebSocket Echo'});
