...
- __admin__: приложение администрирования сисстемы с namespace `MyApp.admin`
- __main__: основное web приложениес namespace `MyApp.main`
- __mobile__: мобильное приложение с namespace `MyApp.mobile`
- __package__: общий пакет разработки для всех проложений с namespace `MyApp`
...
и следим за секцией `requires` в js файлах, для подключения нухных зависимостейю
